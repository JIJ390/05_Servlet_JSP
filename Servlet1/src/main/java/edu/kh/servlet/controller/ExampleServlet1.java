...
//		-> 얻어오고 싶은 input 의 name 속성 값을 작성
//		-> HTML 에서 읽어온 데이터는 기본적으로 모두 String
		String inputName = req.getParameter("inputName");
		String inputAge  = req.getParameter("inputAge");
		
		System.out.printf("%s 의 나이는 %s 세 입니다\n", inputName, inputAge);
...
//		(문자 인코딩 = 사용자가 입력한 문자나 기호들을 
//		               컴퓨터가 이용할 수 있는 신호로 만드는 것)
